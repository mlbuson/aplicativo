...
public class TarjetaDeCredito extends MetodoPago {
    ...
    public TarjetaDeCredito(String numeroTarjeta, String nombreTitular, String fechaExpiracion, int codigoSeguridad, Usuario usuario) {
        super("Tarjeta de Crédito", usuario);
